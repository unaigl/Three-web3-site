...
export default function Web3Child() {
  ...
  useEffect(() => {
    const fetchChainId = async () => {
      try {
        ...
        seterrorMessage('You can connect with Metamask, coinbase or wallet connect at same time (also using different wallets)')
        return errorMessage
      } catch (error) {

        seterrorMessage('TODO*******CORRECT')
        return errorMessage
      }
    }
    fetchChainId()
