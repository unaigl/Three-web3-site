...
const Web3ReactConnectionComponent = () => {
  ...
  return (
    <>
      {web3reactContext.account ? <p className="nav-link">{web3reactContext.account}</p> : <p className="nav-link">0x..................</p>}
      ...
      <li className="nav-item">
        <button className="nav-link" onClick={writeToContractUsingWeb3React}>
          Write
        </button>
      </li>
      <li className="nav-item">
      ...
      <li className="nav-item">
        <button className="nav-link" onClick={connectWalletConnectSimple}>
          WalletConnect
        </button>
      </li>
      <li className="nav-item">
