...
function Foo(props) {
	...
	return (
		<mesh ref={ref} {...props} className='col-md-5 p-5'>
			...
			<div className='row my-screen'>
				<div className='col-md-12'>
					<Canvas
						...
						camera={{
							position: [0, 0, 5] /* , fov: 90 */,
							rotation: [0, 0, 0],
						}}
						// 1- Componentes de utilidad. 2- Componentes para la web.
					>
						<color attach='background' args={['#376bb0']} />
						<Lights />
						<OrbitControls
							enableZoom={false}
							enablePan={false}
							...
							<Scroll html>
								<div className='col-md-5 p-5'>
									...
									<h4 style={{color: 'white'}}>
										Solo los mas atrevidos podran sentarse
										en esta silla
									</h4>
									<span style={{color: 'white'}}>
										Lorem ipsum dolor sit amet consectetur
										adipisicing elit. Asperiores sed dolore,
										et laborum enim tempora eos. Ex adipisci
										dolor atque dolorem sequi nemo odio,
										impedit eum ipsa reiciendis placeat
										error.Lorem ipsum dolor sit amet
										consectetur adipisicing elit. Asperiores
										sed dolore, et laborum enim tempora eos.
										Ex adipisci dolor atque dolorem sequi
										nemo odio, impedit eum ipsa reiciendis
										placeat error.
									</span>
									<br />
									<br />
